...
title:
description:
created: 2026-01-30T13:34:30-05:00
modified: 2026-01-30T15:12:17-05:00
---
# Definition
Also known as systemic sclerosis. Rare connective tissue disorder with an unknown and complex pathogenesis. Two types: localized scleroderma and systemic sclerosis. 
- Localized = thickened skin, dermal fibrosis, no Raynaud phenomenon or internal organ stuff 

Systemic sclerosis has different types:
- Limited systemic sclerosis, used to be known as CREST syndrome 
	- CREST syndrome refers to a constellation of symptoms traditionally associated with limited SSc (can also be seen in diffuse SSc).
		...
		- E: Esophageal hypomotility (systemic sclerosis): smooth muscle atrophy and fibrosis → esophageal dysmotility and decreased lower esophageal sphincter pressure → dysphagia, gastroesophageal reflux, heartburn → aspiration, Barrett esophagus, stricture
			- Hence the relationship to [[10 Gastroenterology/GI Pathologies/GERD]]
...
# Etiology
- Genetic factors and some HLA types 
- Infection with CMV, EBV, parvovirus B19 through molecular mimicry 
- 3 main issues
	- Vascular insult → endothelial cell activation, adhesion molecule exposure → activation of thrombotic and fibrinolytic cascades 
	- Autoimmunity → activated T cells, predominant Th2 profile → profibrotic Th2 cytokines like IL4/5/13
	- Tissue fibrosis
# Epidemiology
- Female predominance, around middle age onset 
# Clinical features
- CREST symptoms
...
- LES becomes hypotonic, making risk for esophageal strictures, increasing risk for Barrett's esophageal strictures, [GERD](10%20Gastroenterology/GI%20Pathologies/GERD.md), [Esophageal Cancer](10%20Gastroenterology/GI%20Pathologies/Esophageal%20Cancer.md) 
- [Interstitial lung diseases](09%20Respirology/Respiratory%20Pathologies/Interstitial%20lung%20diseases.md), showing the restrictive pattern from fibrosis 
...
# Investigations
## Criteria
Score of 9 or higher is positive. 
...
## Autoantibody tests
- Anti-centromere antibodies, but also in other autoimmune conditions
- Anti-topoisomerase I
- Anti-RNA polymerase III
- Anti-U3-RNP (fibrillarin)
- Assess for anemia
- Check for musculoskeletal involvement
- Check for [Pulmonary Function Testing](09%20Respirology/Pulmonary%20Function%20Testing.md) and cardiac involvement, like [Pericardial Effusion](08%20Cardiology/Cardiac%20Pathologies/Pericardial%20Diseases/Pericardial%20Effusion.md)
# Prognosis
- High mortality, usually because of renal crisis before ACE inhibitors started being used 
- End-organ damage, digital ischemia requiring amputation, irreversible pulmonary fibrosis 
# Treatment 
- No treatment
...
- Apparently Nissen fundoplication is contraindicated here because it would close up LES, use aggressive pharmacologic treatments for [GERD](10%20Gastroenterology/GI%20Pathologies/GERD.md) instead 
# References
