...
# Diabetes mellitus
- Classification 
	- Type 1 (t1dm) = islet $\beta$ cell destruction, usually autoimmune (type 1a) or idiopathic (type 1b), leading to absolute insulin deficiency
	- Type 2 (t2dm) = rages from predominant insulin resistance with relative deficiency to a predominant secretory defect
	- Monogenic diabetes = includes MODY (autosomal dominant defects in $\beta$ cell function) and neonatal diabetes
	- Secondary diabetes = caused by exocrine pancreatic disease (pancreatitis, cystic fibrosis), endocrinopathies (Cushing's, acromegaly), or drug-induced states (glucocorticoids)
![](00%20media/{397C9A30-DB91-4C85-860F-2B8334892483}.png)
## General pathophysiology of DM
...
## General diagnosis
- Fasting plasma glucose = $\geq$ 126 mg/dl (70 mmol/l)
- HbA1C = $\geq$ 65%
- Two-hour OGTT (75 g load in like 5 minutes!) = $\geq$ 200 mg/dl (111 mmol/l)
- Random glucose = $\geq$ 200 mg/dl with classic symptoms of hyperglycemia
## General treatment strategies
- Lifestyle management = individualized macronutrient proportions; Mediterranean-style diets can improve lipid profiles and glycemic control soluble fiber delays glucose absorption
- Oral and non-insulin injectable agents
	- Secretagogues = sulfonylureas (eg, glyburide, glimepiride) and meglitinides close k-ATP channels to stimulate insulin release
	- AMPK activators = metformin primarily reduces hepatic gluconeogenesis; it is the recommended first-line therapy at diagnosis
	- PPAR $\gamma$ agonists = thiazolidinediones (eg, pioglitazone) are insulin sensitizers
	- Incretin-based therapies = glp-1 receptor agonists (eg, liraglutide, exenatide) and dpp-4 inhibitors (eg, sitagliptin)
	- Sglt2 inhibitors = (eg, canagliflozin) block renal glucose reabsorption, promoting glycosuria
- Insulin therapy
	- Rapid-acting analogs = (lispro, aspart, glulisine) for prandial coverage
	- Basal insulins = nph (intermediate), glargine/detemir (long-acting), and degludec (ultra-long acting)
## Chronic and acute complications
- Acute complications
	- Hypoglycemia = most common with insulin or secretagogues; characterized by autonomic (sweating, palpitations) and neuroglycopenic (confusion, seizures) symptoms
	- Diabetic ketoacidosis (DKA) = characterized by hyperglycemia, metabolic acidosis, and high serum ketones
	- Hyperglycemic hyperosmolar state (HHS) = severe hyperglycemia and dehydration without significant ketosis; typically seen in t2dm
- Chronic complications
	- Microvascular = retinopathy (leading cause of blindness), nephropathy (characterized by microalbuminuria), and neuropathy (peripheral or autonomic)
	- Macrovascular = accelerated atherosclerosis leading to myocardial infarction, stroke, and peripheral vascular disease (gangrene)
	- Other = diabetic foot ulcers (due to neuropathy and ischemia), acanthosis nigricans, and increased infection risk
## Diabetes and pregnancy
- Metabolic changes = pregnancy induces progressive insulin resistance, primarily driven by progesterone, to ensure glucose flow to the fetus
