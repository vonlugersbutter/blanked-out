...
# Etiology
The pathogenesis is multifactorial and involves a complex interplay of the "brain-gut axis" 
- GI motor abnormalities = patients often exhibit exaggerated rectosigmoid motor responses to stimuli (eg, eating or rectal distention)
	- High-amplitude propagating contractions (HAPCs) are increased in IBS-D and correlate with rapid transit and pain
...
- Postinfectious IBS (pi-IBS) = approximately 10% of patients develop IBS following infectious enteritis risk factors include the severity/duration of the initial infection and psychological comorbidities
	- See [Acute GI Infections](10%20Gastroenterology/GI%20Pathologies/Acute%20GI%20Infections.md)
...
- Frequently overlaps with other functional disorders, including fibromyalgia, headaches, and various genitourinary symptoms
# Clinical features
- Clinical features = pain is typically episodic and crampy, worsened by eating/stress, and improved by flatus or defecation, rarely causes sleep deprivation as pain is usually confined to waking hours
- Alarm features (red flags) = the following warrant aggressive evaluation for organic disease
	- New onset in older age (>40–50)
	- Nocturnal diarrhea or symptoms
	- Rectal bleeding, anemia, or weight loss
	- Fever
	- Steatorrhea
- Diagnostic workup = for patients with typical symptoms and no alarm features, minimal testing is needed
	- Routine screens often include CBC, c-reactive protein, and fecal calprotectin (to rule out [Inflammatory Bowel Disease](10%20Gastroenterology/GI%20Pathologies/Inflammatory%20Bowel%20Disease.md))
...
- Temporal requirement = symptom onset must be at least 6 months prior to diagnosis, with criteria fulfilled for the last 3 months
- Subtyping = classified by predominant stool consistency into IBS-C (constipation), IBS-D (diarrhea), and IBS-M (mixed) however, these subtypes are highly unstable, with 75% of patients switching subtypes within one year
# Prognosis

# Treatment 
- Dietary modalities
	- Low fodmap diet = restricts fermentable carbohydrates that are poorly absorbed and osmotically active it reduces gas and bloating in 50–80% of patients
	- Fiber = soluble fiber (eg, psyllium) is generally effective; however, insoluble fiber (eg, wheat bran) may exacerbate symptoms
- Pharmacotherapy for IBS-D
	- Antidiarrheals = loperamide is a first-line peripheral opioid agonist
...
- Management of pain and global symptoms
	- Antispasmodics = dicyclomine or peppermint oil for acute cramps
	- Antidepressants = tricyclic antidepressants (TCAs) (eg, imipramine) provide visceral analgesic effects at doses lower than those used for depression