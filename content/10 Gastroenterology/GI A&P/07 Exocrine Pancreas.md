...
- Protein-digesting enzymes are secreted in inactive forms (e.g., trypsinogen) to prevent digestion of pancreatic cells
	- Alpha-amylase = hydrolyzes alpha 1-4 linkages in starch to produce maltose, maltotriose, and limit dextrins
	- Pancreatic lipase = hydrolyzes triglycerides into fatty acids and monoglycerides; assisted by colipase
	- Phospholipase a2 = hydrolyzes phospholipids; activated by trypsin
	- Proteases = (trypsin, chymotrypsin, elastase, carboxypeptidases) are secreted as zymogens
		- Trypsinogen is converted to active trypsin by the brush border enzyme enterokinase
		- Trypsin then activates all other pancreatic proteases
- The pancreatic duct joins the common bile duct to form the hepatopancreatic ampulla (Ampulla of Vater), which enters the duodenum
- Pancreatic secretions 
	- Acinar cells = secrete digestive enzymes and some fluid (Na, Cl)
	- Ductal cells = secretes bicarbonate and water to neutralize stomach acid
	- Fluid composition = always isotonic; at high flow rates, cl- is low and hco3- is high
- Development = the pancreas forms from ventral and dorsal buds of the foregut endodermal lining the ventral bud becomes part of the head, the uncinate process, and the main duct; the dorsal bud forms the rest of the head, body, tail, and accessory duct
# Disorders
...
- [Acute Pancreatitis](10%20Gastroenterology/GI%20Pathologies/Acute%20Pancreatitis.md)
- [Chronic Pancreatitis](10%20Gastroenterology/GI%20Pathologies/Chronic%20Pancreatitis.md)
- [Pancreatic Cancer](10%20Gastroenterology/GI%20Pathologies/Pancreatic%20Cancer.md)
